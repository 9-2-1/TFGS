...
`,h.menu.contentdiv=t.children[0]);var a=h.menu.buttondiv=t.children[1];let i=h.menu.buttons={},o=(i.export=a.children[0],i.import=a.children[1],i.edit=a.children[2],i.log=a.children[3],i.cancel=a.children[4],i.save=a.children[5],i.export.addEventListener("click",function(){h.menu.modi||h.data.export()}),i.import.addEventListener("click",function(){h.menu.modi||h.data.import().catch(h.error)}),i.edit.addEventListener("click",function(){h.menu.modi||h.data.edit().then(h.data.save).then(h.menu.load).catch(h.error)}),i.log.addEventListener("click",function(){h.menu.modi||h.log.create()}),!1);e.onResize=function(){o!==e.isMinimize&&(e.isMinimize?h.menu.modi&&e.restore():h.menu.load(),o=e.isMinimize)},i.save.addEventListener("click",function(){if(h.menu.modi)try{h.menu.save().then(function(){h.menu.load(),h.menu.setmodi(!1)}).catch(h.error)}catch(e){h.error(e)}}),i.cancel.addEventListener("click",function(){if(h.menu.modi&&confirm("取消更改？"))try{h.menu.load(),h.menu.setmodi(!1)}catch(e){alert(e.message)}});var r,l=h.func.list;let s=h.menu.list={};for(r in l){var c=l[r];let e=h.element.create("div","tfgsMenuFunc"),i=(e.innerHTML=`
...
`,e.children);r[8].addEventListener("click",function(){try{{var i=Number(r[0].value),o={primary:r[2].value,secondary:r[4].value,gradientType:r[6].value},s=l.selele("paint-editor_editor-container-top_").children[1].children[0].children[i];let e=l.reactInternal(s).return.return.return.stateNode,t=(e.handleChangeGradientType(o.gradientType),e.props.onChangeColorIndex(0),e.handleChangeColor(o.primary),"SOLID"!==o.gradientType&&(e.props.onChangeColorIndex(1),e.handleChangeColor(o.secondary)),e.handleCloseColor(),e.props.onUpdateImage(),l.vm()),n=h.funcapi.paint().color;var a=1===i?"strokeColor":"fillColor";n[a].gradientType=o.gradientType,n[a].primary=o.primary,n[a].secondary=o.secondary,t.refreshWorkspace()}}catch(e){l.onerror(e)}}),n.innerDiv.appendChild(e)}}h.func.add({id:"forcecolor",name:"强行设定颜色",onenable:function(e){l=e,-1===t&&(t=setInterval(i,100))},ondisable:function(){-1!==t&&(clearInterval(t),t=-1),null!==n&&(n.close(),n=null)},onoption:function(){}})}{let r,l,i,o,s=-1,a=-1,c=0;const b=1200;function f(e){2===e.button&&m(e.clientX,e.clientY)}function p(e){0!==e.touches.length&&m((e=e.touches[0]).clientX,e.clientY)}function m(t,e){t=document.elementFromPoint(t,e);let i,o;if(null!==t){let e=function(e){for(;null!==e&&"svg"!==e.tagName.toLowerCase();)e=e.parentElement;return e}(t);null!==e&&(i=e.classList.contains("blocklyFlyout"),o=function(e){for(;null!==e&&"svg"!==e.tagName.toLowerCase();){if("g"===e.tagName.toLowerCase()){var t=e.getAttribute("data-id");if(null!==t)return t}e=e.parentElement}return null}(t),-1!==a&&(clearInterval(a),a=-1),c=0,a=setInterval(function(){var e,n,t=r.selele("blocklyContextMenu");null!==t?(clearInterval(a),a=-1,i,e=o,n=t,null!==e?(g("复制这个积木",function(){v(e,!1,!0),n.remove()},n),g("复制这组积木",function(){v(e,!0,!1),n.remove()},n)):(g("复制全部积木",function(){v(null,!0,!1),n.remove()},n),g("粘贴积木文本",function(){function t(e){let t=r.blockly();var e=t.Xml.textToDom(e),n=t.Xml.domToWorkspace(e,l);if(0===n.length)throw new Error("粘贴失败");var i,e=l.getMetrics(),o=e.viewLeft+15;let s=e.viewTop+15;for(let t=0;t<n.length;t++){let e=l.getBlockById(n[t]);null===e.getParent()&&(i=e.getRelativeToSurfaceXY(),e.moveBy(o/l.scale-i.x,s/l.scale-i.y),s+=(e.getHeightWidth().height+30)*l.scale)}}"clipboard"in navigator?navigator.clipboard.readText().then(t).catch(function(e){r.onerror(e),t(prompt("在下方粘贴:"))}):t(prompt("在下方粘贴:")),n.remove()},n))):(c+=10)>=b&&(clearInterval(a),a=-1)},10))}}function g(e,t,n){let i=document.createElement("div");i.classList.add("goog-menuitem"),i.setAttribute("role","menuitem"),i.style.userSelect="none",i.innerText=e,i.addEventListener("click",t),n.parentElement.style.height="4500px",n.appendChild(i)}function v(i,o,s){try{let t=r.blockly();var a=t.Xml.workspaceToDom(l);let n;if(null===i)n=t.Xml.domToText(a,l);else{let e=function t(e,n){if(e.getAttribute("id")===n)return e;var i=e.children;for(let e=0;e<i.length;e++){var o=t(i[e],n);if(null!==o)return o}return null}(a,i);for(;null!==e&&"block"!==e.tagName.toLowerCase();)e=e.parentElement;if(null===e)throw new Error("复制失败:找不到积木");if(s){let t=e.children;for(let e=0;e<t.length;e++)"next"===t[e].tagName.toLowerCase()&&(t[e].remove(),e--)}if(o)for(;null!==e.parentElement&&("block"===e.parentElement.tagName.toLowerCase()||"next"===e.parentElement.tagName.toLowerCase());)e=e.parentElement;n="<xml>"+t.Xml.domToText(e,l)+"</xml>"}"clipboard"in navigator?navigator.clipboard.writeText(n).then(function(){}).catch(function(e){r.onerror(e),prompt("请复制以下内容",n)}):prompt("请复制以下内容",n)}catch(e){r.onerror(e)}}h.func.add({id:"copyblock",name:"复制积木为文字",info:"在右键菜单中添加“复制积木”“粘贴积木”选项，可以跨作品复制，或者粘贴到记事本(是xml格式)",default:!1,option:{},onenable:function t(e,n){r=e,n=void 0===n?0:n;try{l=r.workspace(),i=r.toolbox(),(o=r.selele("injectionDiv")).addEventListener("touchstart",p,!0),document.body.addEventListener("mousedown",f,!0),r.log("打开")}catch(e){return r.onerror(e),r.log("启动失败次数: ",n+1),void(s=setTimeout(function(){t(r,n+1)},1e3))}},ondisable:function(){-1!==s&&(clearTimeout(s),s=-1),o&&o.removeEventListener("touchstart",p,!0),document.body.removeEventListener("mousedown",f,!0),r.log("关闭")},onoption:function(){}})}let t;h.func.add({id:"example",name:"自定义窗口标题",author:"作者名字",version:"v0.1.0",info:"让你能够修改窗口的标题",default:!1,option:{title:{type:"text",name:"窗口标题",maxlength:16,default:"示例标题"}},onenable:function(e){t=document.title,document.title=e.getoption().title},ondisable:function(e){document.title=t},onoption:function(e){document.title=e.getoption().title}});let n;function a(){let e=h.window.create({title:"Teriteri",canMaximize:!1,canMinimize:!1,canResize:!1,height:130,width:130,onClose:r});e.innerDiv.style="vertical-align:middle;text-align:center;font-size:80px;",e.innerDiv.innerText="☆",n.push(e)}function r(){n.splice(n.indexOf(this),1),a(),a()}h.func.add({id:"windowf___",name:"window f___",onenable:function(e){n=[],a()},ondisable:function(){for(var e in n)n[e].onClose=function(){},n[e].close()},onoption:function(){}});{let t,n=null,a=null,i="?",r=null,e=-1,o="?";function l(){if(-1===e)e=setInterval(l,100);else{if(null===r){n=document.getElementById("gandi-terminal"),a=n.children[1];let e=window.getComputedStyle(a),i=h.element.create("span","tfgsCCWtermSpan"),o=Number(e.width.slice(0,-2))+20,s=Number(e.height.slice(0,-2))+20;t.log(e.width),t.log(e.height),r=h.window.create({title:"wterm",canClose:!1,width:o+6,height:s+26,onResize:function(){let e=window.getComputedStyle(this.innerDiv);var t=Number(e.width.slice(0,-2)),n=Number(e.height.slice(0,-2));i.style.setProperty("--scale",Math.min(t/o,n/s))}}),i.innerHTML="<span></span>",i.children[0].appendChild(a),i.style.setProperty("--termWidth",o+"px"),i.style.setProperty("--termHeight",s+"px"),r.innerDiv.appendChild(i),n.style.display="none"}if(r.title=n.children[0].children[0].innerText,r._refresh(),i!==n.style.visibility)if(i=n.style.visibility,t.log("visibility: "+i),"visible"!==n.style.visibility)switch(t.getoption().mode){case"respect":r.windowDiv.style.visibility="hidden";break;case"minmax":case"minshow":r.minimize()}else{switch(r.windowDiv.style.visibility="visible",r.movetotop(),t.getoption().mode){case"respect":break;case"minmax":r.restore()}r.flash(200,3,!0)}}}h.func.add({id:"ccwterm",name:"将ccw控制台放入tfgs窗口",info:"这个东西，我们叫它'Terminal'(终端)，微软叫它'Console'(控制台)，用着xterm又叫它控制台的ccw是",default:!1,option:{mode:{type:"menu",name:"响应控制台消息",menu:["尊重显示和隐藏操作","将显示/隐藏理解为还原/最小化","显示时闪烁,隐藏时最小化","忽略隐藏请求"],value:["respect","minmax","minshow","ignore"],default:"respect"}},onenable:function(e){t=e,i="?",o=t.getoption().mode,l()},ondisable:function(){-1!==e&&(clearInterval(e),e=-1),null!==r&&(r.close(),r=null),null!==n&&(n.style.display="block",n.appendChild(a))},onoption:function(){t.getoption().mode!==o&&(i="?",o=t.getoption().mode)}})}{let e=document.createElement("style");e.innerHTML='.tfgsLogFormat{display:block;white-space:pre-wrap;word-break:break-all;font-family:monospace;font-size:15;overflow:scroll}.tfgsLogFormat>:nth-child(odd){background:#f0f8ff}.tfgsLogFormat>:nth-child(2n){background:#def}.tfgsLogContent{height:calc(100% - 30px);background:#fff}.tfgsLogButtons{height:30px;background:var(--tfgsWindowColor)}.tfgsButton{display:inline-block;min-width:40px;height:25px;line-height:25px;text-align:center;font-size:16px;margin:2px;background:#fff;user-select:none;border-radius:2px;box-shadow:0 0 2px rgba(0,0,0,.5)}.tfgsButton:active{background:#9cf}.tfgsDisable{display:none}.tfgsRight{float:right}.tfgsWindow.tfgsEmergency{--tfgsWindowColor:#f80}.tfgsWindow{--tfgsWindowColor:#08f;box-shadow:0 0 2px #000;position:fixed;background:#fff;border:3px solid var(--tfgsWindowColor);border-radius:3px;overflow:hidden;box-sizing:border-box}.tfgsWindow *{box-sizing:content-box}.tfgsWindowTitle{background:var(--tfgsWindowColor);display:flex;display:-webkit-flex;flex-flow:row nowrap;align-items:center;border-bottom:3px solid var(--tfgsWindowColor);color:#fff;font-family:sans-serif;font-size:16px;line-height:20px;height:20px}.tfgsWindowTitle>span{width:20px;height:20px;text-align:center;flex:none;user-select:none;-moz-user-select:none}.tfgsWindowTitle>span:active{background:rgba(0,0,0,.25);box-shadow:1px 1px 2px rgba(0,0,0,.3) inset}.tfgsWindowTitle>.tfgsWindowText{width:fit-content;flex:auto;overflow:hidden;white-space:pre;text-overflow:ellipsis;text-overflow:"...";position:relative}.tfgsWindowTitle>.tfgsWindowText:active{background:0 0;box-shadow:none}.tfgsWindowContent{height:calc(100% - 20px - 2px);overflow:auto;position:relative}.tfgsWindowResize{position:absolute;right:0;bottom:0;width:0;height:0;border-left:15px solid transparent;border-bottom:15px solid var(--tfgsWindowColor);cursor:se-resize}.tfgsWindowResize:after{content:"=";position:absolute;left:-8px;top:0;transform:rotate(-45deg);color:#fff}.tfgsMenuContent{height:calc(100% - 30px);background:#f0f8ff;overflow:auto;text-align:center}.tfgsMenuButtons{height:30px;background:var(--tfgsWindowColor)}.tfgsMenuFunc{margin:5px;border-radius:2px;box-shadow:0 0 2px rgba(0,0,0,.5);overflow:hidden;text-align:left}.tfgsMenuFuncOption{background:#def;padding:2px}.tfgsMenuFuncOptionOne{display:inline-block;margin:2px;padding:2px;background:#bdf;box-shadow:0 0 2px rgba(0,0,0,.5);border-radius:2px;min-width:calc(25% - 10px);max-width:calc(100% - 10px)}.tfgsMenuFunc input,.tfgsMenuFunc select{position:relative;vertical-align:middle;border:none;background:#fff;width:100px;height:20px;margin:2px;padding:2px;box-shadow:0 0 2px rgba(0,0,0,.5);border-radius:2px}.tfgsMenuFuncOptionOne>input{box-shadow:0 0 2px rgba(0,0,0,.5) inset}.tfgsMenuFuncOptionOne>input[type=checkbox],.tfgsMenuFuncTitle>input{width:20px;height:20px;box-shadow:0 0 2px rgba(0,0,0,.5)}.tfgsMenuFunc input:active,.tfgsMenuFunc select:active{background:#9cf}.tfgsMenuFunc input:focus,.tfgsMenuFunc select:focus{background:#def;outline:0}.tfgsMenuFuncTitle{background:#08f;color:#fff;padding:2px;font-weight:700;font-family:monospace}.tfgsMenuFuncInfo{font-size:12px}.tfgsMenuFuncName{font-size:15px}span.tfgsGuimodifyButton{position:absolute;color:grey;font-size:1em;line-height:1em;text-align:center}body.tfgsGuimodifyMenubarFold div[class^=gui_menu-bar-position_]{top:calc(0px - var(--tfgsGuimodifyMenubarHeight));margin-bottom:calc(0px - var(--tfgsGuimodifyMenubarHeight))}body.tfgsGuimodifyMenubarFold div[class^=gui_body-wrapper_]{height:100%}body.tfgsGuimodifyBlocktoolFold .blocklyFlyout,body.tfgsGuimodifyBlocktoolFold .blocklyFlyoutScrollbar{left:-250px}body.tfgsGuimodifyStagetargetFold div[class^=gui_stage-and-target-wrapper_]{display:none}body.tfgsGuimodifySpriteinfoFold div[class^=sprite-info_sprite-info_]{max-height:0;padding:0;overflow:hidden}body.tfgsGuimodifyStagebuttonFold div[class^=target-pane_stage-selector-wrapper_]{max-width:0;padding:0;margin-left:0;margin-right:0;overflow:hidden}body.tfgsGuimodifyStageFold div[class^=stage-wrapper_stage-canvas-wrapper_]{max-height:0;padding:0;overflow:hidden}body.tfgsGuimodifyFullscreen{overflow:scroll}body.tfgsGuimodifyExpand100{position:fixed;bottom:0}body.tfgsGuimodifyAssetpanelFold [class^=selector_wrapper_]{position:absolute;height:100%;width:100%;z-index:2}body.tfgsGuimodifyAssetpanelFold [class^=selector_list-area_]{flex-direction:row;flex-wrap:wrap;align-content:flex-start}body.tfgsGuimodifyAssetpanelFold [class*=" sprite-selector-item_sprite-selector-item_"]{margin-left:.8em}body.tfgsGuimodifyAssetpanelFold [class^=asset-panel_detail-area_]{padding-left:45px}.tfgsCCWtermSpan{position:absolute;height:100%;width:100%;display:flex;align-items:center;justify-content:center}.tfgsCCWtermSpan>span{display:inline-block;width:calc(var(--termWidth) * var(--scale));height:calc(var(--termHeight) * var(--scale));overflow:hidden}.tfgsCCWtermSpan>span>div#terminal-container{background:#000;transform:scale(var(--scale));transform-origin:-10px -10px}.tfgsForcecolorWin{font-size:16px;text-align:center}.tfgsForcecolorWin input{width:150px;border:1px solid #000}.tfgsForcecolorWin pre{font-size:8px}',document.head.appendChild(e)}h.data.load().then(h.menu.create).catch(h.error)}catch(e){throw alert(e.message),console.error(e),e}